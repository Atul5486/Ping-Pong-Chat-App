...
const Notification = () => {
  ...
  const acceptRequest = friendRequests?.acceptedRequest || [];
  ...
  return (
    ...
    <h4 className='mb-2'>No Notification available</h4>
    <p className='para'>
                    ...
                    {acceptRequest.map((request) => (
                      ...
                      >
                        <div className="card-body">
                          ...
                          <button className="badge badge-info badge-soft text-xs">
